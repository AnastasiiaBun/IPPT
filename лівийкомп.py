...
left_comp_ip = '192.168.0.104'
middle_comp_ip = '192.168.0.104'

SEND_IP_PORT1 = (left_comp_ip,10000)
SEND_IP_PORT2 = (middle_comp_ip,10002)
SEND_IP_PORT2_2 = (middle_comp_ip,10003)

IP_PORT1 = (left_comp_ip,11000)
IP_PORT2 = (middle_comp_ip,11001)
...
def send() : 
    ...
    msg_l = c.coords(BALL)
    msg = str(msg_l[0]) + ',' + str(msg_l[1]) + ',' + str(msg_l[2]) + ',' + str(msg_l[3]) + ',' + str(BALL_X_CHANGE) + ','+ str(BALL_Y_CHANGE) + ',' + 'LEFT'
    msg = msg.encode('UTF-8')
    soc.sendto(msg,IP_PORT2)
    soc.sendto(msg,IP_PORT2)
    BALL_Y_SPEED = 0
    BALL_X_SPEED = 0
...
c = Canvas(root, width=WIDTH, height=HEIGHT, background= "#7B68EE")
c.pack()
...
LEFT_PAD = c.create_line(LEFT_PAD_W/2, 0, LEFT_PAD_W/2, LEFT_PAD_H, width=LEFT_PAD_W, fill="#4B0082")
 

RIGHT_PAD = c.create_line(WIDTH-RIGHT_PAD_W/2, 0, WIDTH-RIGHT_PAD_W/2, 
                          RIGHT_PAD_H, width=RIGHT_PAD_W, fill="#4B0082")
